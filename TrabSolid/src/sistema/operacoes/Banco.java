...
import sistema.banco.Cliente;
import sistema.banco.Conta;
import sistema.banco.ContaCorrente;
import sistema.banco.ContaPoupanca;
...
public class Banco {
    ...
    public void efetuarTransferencia() {
        ...
        List<Object> contasOrigem = Collections.singletonList(contas.getOrDefault(cpfOrigem, new ArrayList<>()));
        List<Object> contasDestino = Collections.singletonList(contas.getOrDefault(cpfDestino, new ArrayList<>()));
    ...
    private Conta selecionarContaPorTipo(List<Object> contas, int tipo) {
        for (Object c : contas) {
    ...
    public void exibirSaldoDepoisTransferencia(Conta contaOrigem, Conta contaDestino) {
        if (contaOrigem != null) {
            System.out.println("Saldo da conta origem após a transferência: " + contaOrigem.getSaldo());
        }
